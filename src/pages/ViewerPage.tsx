...
export default function ViewerPage() {
  ...
  const { room, scenes, objects, loading, updateObject, updateObjectImmediate, localUpdateObject, deleteObject, videoCommands, hideAllObjects, hideCharacterObjects, roomBroadcast, shakeCommand, flashCommand, textOverlayCommand, countdownCommand, bounceCommands, grayscaleState } = useRoom(roomId);
