...
export default function ObsPage() {
  ...
  const { room, scenes, objects, loading, videoCommands, hideAllObjects, hideCharacterObjects, tempHiddenId, shakeCommand, flashCommand, textOverlayCommand, countdownCommand, bounceCommands, grayscaleState } = useRoom(roomId ?? null);
